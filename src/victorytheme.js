...
const peach = "#fcaa67",
	...
	grey = "#212121",
	purpleMain = '#a78bfa'
const colors = [peach, red, cream, burgundy, green, darkBlue, teal];
// *
// * Typography
// *
...
const theme = {
	...
	boxplot: assign(
		{
			style: {
				max: {padding: 8, stroke: red, strokeWidth: 1},
				maxLabels: assign({}, baseLabelStyles, {padding: 3}),
				median: {padding: 8, stroke: peach, strokeWidth: 1},
				medianLabels: assign({}, baseLabelStyles, {padding: 3}),
				min: {padding: 8, stroke: cream, strokeWidth: 1},
